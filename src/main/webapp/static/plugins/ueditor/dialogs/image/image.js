/**
 * Upload picture dialog logic code, including tab: remote picture/upload picture/online picture/search picture
 */
...
(function () {
        ...
        dialog.onok = function () {
            ...
            switch (id) {
                ...
                case 'upload':
                    ...
                    if (count) {
                        $('.info', '#queueList').html('<span style="color:red;">' + 'There are 2 unuploaded files'.replace(/[\d]/, count) + '</span>');
                        return false;
                    }
                    break;
                case 'online':
    ...
    /* Initialize the click event on the way */
    function initAlign(){
    ...
    RemoteImage.prototype = {
        ...
        setImage: function(img){
            ...
            /* Prevent onchange event loop call */
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // The content before the file is not selected.
            ...
            // Total size of files added
                fileSize = 0,
            // Optimize retina, this value is 2 under retina
                ratio = window.devicePixelRatio || 1,
            // Thumbnail size
                thumbnailWidth = 113 * ratio,
                thumbnailHeight = 113 * ratio,
            // There may be pedding, ready, uploading, confirm, done.
                state = '',
            // Progress information of all files, the key is file id
                percentages = {},
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                duplicate: true,
                fileSingleSizeLimit: imageMaxSize,    //  2 M
                compress: editor.getOpt('imageCompressEnable') ? {
                    width: imageCompressBorder,
                    height: imageCompressBorder,
                    // The image quality is only valid when the type is `image/jpeg`.
                    quality: 90,
                    // Whether to allow zooming, if you want to generate small images without distortion, this option should be set to false.
                    allowMagnify: false,
            ...
            // Execute when a file is added, responsible for the creation of the view
    ...
    OnlineImage.prototype = {
        ...
        /* Initialize the scroll event, scroll to the point to automatically pull data */
        initEvents: function () {
            var _this = this;
        ...
        initData: function () {
            ...
            /*The value that needs to be used to pull data */
            this.state = 0;
        ...
        /* Pull the picture list data to the background */
